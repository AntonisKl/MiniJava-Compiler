    ...
    public String toString() {
        ...
        while (iter.hasNext()) {
            ...
            if (curEntryValueString.length() > 2 && curEntryValueString.charAt(0) == '{'
                    && curEntryValueString.charAt(curEntryValueString.length() - 1) == '}') {
                String[] keyValuePairs = curEntryValueString.substring(1, curEntryValueString.length() - 1).split(","); //split the string to creat key-value pairs
